...
##### Female Mouse #####
##Input Data
training.data.mf=read.table("trainingData_Mf_griswold(MAS5)_final.txt",row.names=1,header = TRUE, sep="\t")
pred.data.mf=read.table("embryonic_mouse-m430_2_new_fm_only_GeneName.na30.txt",row.names=1, sep="\t")
colnames(pred.data.mf)=c("TP1","TP2","TP3","TP4");
pred.data.mf=round(pred.data.mf,3)
##Example Command-svm
model.test(training.data=training.data.mf, pred.data=pred.data.mf, fold=5, model="svm", method="radial", gamma=0.5 , cost=32, output.file="Mf.griswold.rand.txt",para="FALSE",n=100, m=50)
##Example Command-logis
model.test(training.data=training.data.mf, pred.data=pred.data.mf, fold=5, model="logistic",output.file="Mf.griswold.rand.logis.txt",para="FALSE",n=100, m=50)

##### Male Mouse #####
##Input Data
training.data.mm=read.table("trainingData_Mm_final.txt",row.names=1,header = TRUE, sep="\t")
pred.data.mm=read.table("embryonic_mouse-m430_2_new_mm_only_GeneName.na30.txt",row.names=1, sep="\t")
colnames(pred.data.mm)=c("TP1","TP2","TP3","TP4");
pred.data.mm=round(pred.data.mm,3)
##Example Command
model.test(training.data=training.data.mm, pred.data=pred.data.mm, fold=5, model="svm", method="radial", gamma=0.03125 , cost=16384 , output.file="Mm.griswold.rand.txt",para="FALSE",n=100, m=50)
##Example Command-logis
model.test(training.data=training.data.mm, pred.data=pred.data.mm, fold=5, model="logistic",output.file="Mm.griswold.rand.logis.txt",para="FALSE",n=100, m=50)

##### Female Human #####
##Input Data
training.data.hf=read.table("trainingData_Hf_final.txt",row.names=1,header = TRUE, sep="\t")
...
##Example Command
model.test(training.data=training.data.hf, pred.data=pred.data.hf, fold=5, model="svm", method="radial" , gamma=4, cost=1, output.file="Hf.griswold.rand.txt",para="FALSE",n=100, m=50)
##Example Command-logis
model.test(training.data=training.data.hf, pred.data=pred.data.hf, fold=5, model="logistic",output.file="Hf.griswold.rand.logis.txt",para="FALSE",n=100, m=50)
################################################################################################
